...
[Link to the slides](https://docs.google.com/presentation/d/1nr1iNvllwkr2UorulvrPxBd-E-VGa7PmlZvasYQV54c/edit#slide=id.g226bdc9f41d_0_0)
...
### analysis-for-collected-data.ipynb
This file generates the features of the collected data from Arduino. The extracted featurs will be stored in `data/arduino_ppg/processed` as csv format. The csv files will be used in `evaluation.ipynb`.
